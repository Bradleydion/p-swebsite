...
export default function AboutUs() {
  return (
    <Box sx={{ mt: 10 }}>
      <Typography sx={{ mx: 80, my: 5 }} variant="h5">
        About Us
      </Typography>
      <Typography sx={{ mx: 5 }} variant="body2" color="text.secondary">
      ...
      <Typography sx={{ mx: 75, my: 5 }} variant="h5">
        Company Profiles
      </Typography>
      <Box
        sx={{
      ...
      >
        <Card sx={{ my: 5, maxWidth: 345 }}>
          ...
          <CardContent>
            ...
            <Typography variant="body2" color="text.secondary">
              ...
              Webster College. He currently holds a Commonwealth of
              Massachusetts Construction Supervisor’s License and is a member of
              the Board of Directors of the Associated Builders and Contractors
              New Hampshire/Vermont Chapter and served as Chairman of the Board
              in 2016. Mark currently serves as a member of the National Board
              of Directors for the Associated Builders and Contractors (ABC).
            </Typography>
          </CardContent>
        </Card>
        <Card sx={{ my: 5, maxWidth: 345 }}>
          ...
          <CardContent>
            ...
            <Typography variant="body2" color="text.secondary">
              Skip has been in the industry for more than 30 years. His
              expertise is in HVAC and Sheet Metal Installation and he is a
              graduate of the Associated Builders and Contractors Project
              Management Institute at Purdue University.
            </Typography>
          </CardContent>
        </Card>
        <Card sx={{ my: 5, maxWidth: 345 }}>
          ...
          <CardContent>
            ...
            <Typography variant="body2" color="text.secondary">
              {" "}
              Melanie has been in the human resources and accounting industry
              for 20 years; She has a BA in Accounting/Finance as well as Human
              Resource Management. She holds her certifications and Bachelor's
              in Human Resource Management from Franklin Pierce University. She
              is a current member of SHRM.
            </Typography>
          </CardContent>
        </Card>
        <Card sx={{ my: 5, maxWidth: 345 }}>
        ...
        <Card sx={{ my: 5, maxWidth: 345 }}>
          ...
          <CardContent>
            ...
            <Typography variant="body2" color="text.secondary">
              ...
              Safety and Sheet Metal. He is a graduate of the Associated
              Builders and Contractors Project Management Institute at Purdue
              University and the Associated Builders and Contractors Future
              Leaders in Construction program.
            </Typography>
          </CardContent>
        </Card>
        <Card sx={{ my: 5, maxWidth: 345 }}>
          ...
          <CardContent>
            ...
            <Typography variant="body2" color="text.secondary">
              {" "}
              Marc has over 30 years’ experience in the construction industry.
              His expertise includes HVAC Service, Refrigeration, Sheet Metal
              duct system installation and carpentry. He holds certifications in
              Heating and Cooling from New Hampshire Vocational Technical
              College as well as numerous certifications in the operation,
              repair, and service of multiple HVAC manufacturers systems.
            </Typography>
          </CardContent>
        </Card>
        <Card sx={{ my: 5, maxWidth: 345 }}>
        ...
        <Card sx={{ my: 5, maxWidth: 345 }}>
          ...
          <CardContent>
            ...
            <Typography variant="body2" color="text.secondary">
              {" "}
              Dave has 20 years' experience in the CAD industry with a wide
              range of experience in Civil, Oil, Gas, Architectural and HVAC
              Design.
            </Typography>
          </CardContent>
        </Card>
        ...
        <Card sx={{ my: 5, maxWidth: 345 }}>
          ...
          <CardContent>
            ...
            <Typography variant="body2" color="text.secondary">
              ...
              and Sicard he then became a Small Projects Foreman/Supervisor and
              is now a Project Manager. Keith has numerous certifications, ABC
              site super training an OSHA 30 certification as well as NH gas
              fitter and installers licenses.
            </Typography>
          </CardContent>
        </Card>
        <Card sx={{ my: 5, maxWidth: 345 }}>
